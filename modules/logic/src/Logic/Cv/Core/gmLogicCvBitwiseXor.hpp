    ...
    namespace Logic
    {
        namespace Cv
        {
            ...
            public:
                ...
                static Register<BitwiseXor> Register;
                ...
                auto run() -> void override
                {
                    ...
                    for (auto it : this->inputIterator())
                    {
                        ...
                        cv::bitwise_xor(Image::ToCv(it.image(0)), Image::ToCv(it.image(1)), dest, mask);
