...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class NaryMaximumImageFilter : public NaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<NaryMaximumImageFilter> Register;
                ...
                NaryMaximumImageFilter() : NaryFunctorImageFilter("NaryMaximumImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::NaryMaximumImageFilter<ImageType, ImageType>;
