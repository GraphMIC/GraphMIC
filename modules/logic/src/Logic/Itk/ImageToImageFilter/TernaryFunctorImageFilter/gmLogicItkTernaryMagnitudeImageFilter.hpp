...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class TernaryMagnitudeImageFilter : public TernaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<TernaryMagnitudeImageFilter> Register;
                ...
                TernaryMagnitudeImageFilter() : TernaryFunctorImageFilter("TernaryMagnitudeImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::TernaryMagnitudeImageFilter<ImageType, ImageType, ImageType, ImageType>;
