...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class TernaryAddImageFilter : public TernaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<TernaryAddImageFilter> Register;
                ...
                TernaryAddImageFilter() : TernaryFunctorImageFilter("TernaryAddImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::TernaryAddImageFilter<ImageType, ImageType, ImageType, ImageType>;
