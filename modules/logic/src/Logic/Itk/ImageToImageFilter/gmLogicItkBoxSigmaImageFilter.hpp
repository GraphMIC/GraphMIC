...
#include "gmLogicItkBoxImageFilter.hpp"
...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class BoxSigmaImageFilter : public BoxImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<BoxSigmaImageFilter> Register;
                ...
                BoxSigmaImageFilter() : BoxImageFilter("BoxSigmaImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    BoxImageFilter::applyParameters<FilterType>(filter);
