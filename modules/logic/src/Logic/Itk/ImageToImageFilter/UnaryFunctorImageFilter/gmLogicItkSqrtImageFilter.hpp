...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class SqrtImageFilter : public UnaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<SqrtImageFilter> Register;
                ...
                SqrtImageFilter() : UnaryFunctorImageFilter("SqrtImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::SqrtImageFilter<ImageType, ImageType>;
                    
                    auto filter         = FilterType::New();
                    auto output         = this->getOutput<Data::Image>(ID::output);
                    
                    UnaryFunctorImageFilter::applyParameters<FilterType>(filter);
