...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class LogImageFilter : public UnaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<LogImageFilter> Register;
                ...
                LogImageFilter() : UnaryFunctorImageFilter("LogImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::LogImageFilter<ImageType, ImageType>;
