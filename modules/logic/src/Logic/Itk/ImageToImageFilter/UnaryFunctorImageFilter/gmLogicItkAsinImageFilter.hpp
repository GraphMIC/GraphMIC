...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class AsinImageFilter : public UnaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<AsinImageFilter> Register;
                ...
                AsinImageFilter() : UnaryFunctorImageFilter("AsinImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::AsinImageFilter<ImageType, ImageType>;
