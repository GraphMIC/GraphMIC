...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class BoundedReciprocalImageFilter : public ImageToImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<BoundedReciprocalImageFilter> Register;
                ...
                BoundedReciprocalImageFilter() : ImageToImageFilter("BoundedReciprocalImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::BoundedReciprocalImageFilter<ImageType, ImageType>;
