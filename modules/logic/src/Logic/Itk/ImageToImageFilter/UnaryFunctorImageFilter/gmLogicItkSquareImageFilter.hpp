...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class SquareImageFilter : public UnaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<SquareImageFilter> Register;
                ...
                SquareImageFilter() : UnaryFunctorImageFilter("SquareImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::SquareImageFilter<ImageType, ImageType>;
