...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class ExpImageFilter : public UnaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<ExpImageFilter> Register;
                ...
                ExpImageFilter() : UnaryFunctorImageFilter("ExpImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::ExpImageFilter<ImageType, ImageType>;
