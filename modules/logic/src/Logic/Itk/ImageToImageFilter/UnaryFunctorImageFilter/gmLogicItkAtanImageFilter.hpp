...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class AtanImageFilter : public UnaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<AtanImageFilter> Register;
                ...
                AtanImageFilter() : UnaryFunctorImageFilter("AtanImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::AtanImageFilter<ImageType, ImageType>;
