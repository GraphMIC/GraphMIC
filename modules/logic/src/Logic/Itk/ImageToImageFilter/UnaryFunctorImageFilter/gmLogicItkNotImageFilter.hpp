...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class NotImageFilter : public UnaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<NotImageFilter> Register;
                ...
                NotImageFilter() : UnaryFunctorImageFilter("NotImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::NotImageFilter<ImageType, ImageType>;
