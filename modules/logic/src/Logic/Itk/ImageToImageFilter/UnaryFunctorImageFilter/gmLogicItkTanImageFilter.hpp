...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class TanImageFilter : public UnaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<TanImageFilter> Register;
                ...
                TanImageFilter() : UnaryFunctorImageFilter("TanImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::TanImageFilter<ImageType, ImageType>;
