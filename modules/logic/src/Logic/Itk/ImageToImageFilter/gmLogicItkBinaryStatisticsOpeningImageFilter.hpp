...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class BinaryStatisticsOpeningImageFilter : public ImageToImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<BinaryStatisticsOpeningImageFilter> Register;
                ...
                BinaryStatisticsOpeningImageFilter() : ImageToImageFilter("BinaryStatisticsOpeningImageFilter")
                {
                    log_trace(Log::New);
                    
                    this->addParamGroup("BinaryStatisticsOpeningImageFilter");
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::BinaryStatisticsOpeningImageFilter<ImageType, ImageType>;
                    ...
                    {
                        filter->SetInput1(Image::ToItk<ImageType>(it.image()));
                        filter->Update();
