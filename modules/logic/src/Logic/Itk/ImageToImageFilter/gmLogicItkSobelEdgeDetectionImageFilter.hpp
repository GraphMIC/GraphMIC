...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class SobelEdgeDetectionImageFilter : public ImageToImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<SobelEdgeDetectionImageFilter> Register;
                ...
                SobelEdgeDetectionImageFilter() : ImageToImageFilter("SobelEdgeDetectionImageFilter")
                {
                    log_trace(Log::New);
