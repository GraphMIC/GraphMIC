...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class BinaryShapeKeepNObjectsImageFilter : public ImageToImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<BinaryShapeKeepNObjectsImageFilter> Register;
                ...
                BinaryShapeKeepNObjectsImageFilter() : ImageToImageFilter("BinaryShapeKeepNObjectsImageFilter")
                {
                    log_trace(Log::New);
                    
                    this->addParamGroup("BinaryShapeKeepNObjectsImageFilter");
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::BinaryShapeKeepNObjectsImageFilter<ImageType>;
