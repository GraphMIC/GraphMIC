...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class HMinimaImageFilter : public ImageToImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<HMinimaImageFilter> Register;
                ...
                HMinimaImageFilter() : ImageToImageFilter("HMinimaImageFilter")
                {
                    log_trace(Log::New);
                    
                    this->addParamGroup("HMinimaImageFilter");
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::HMinimaImageFilter<ImageType, ImageType>;
