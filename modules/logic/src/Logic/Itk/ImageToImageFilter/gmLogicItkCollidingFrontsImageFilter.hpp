...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class CollidingFrontsImageFilter : public ImageToImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<CollidingFrontsImageFilter> Register;
                ...
                CollidingFrontsImageFilter() : ImageToImageFilter("CollidingFrontsImageFilter")
                {
                    log_trace(Log::New);
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::CollidingFrontsImageFilter<ImageType, ImageType>;
