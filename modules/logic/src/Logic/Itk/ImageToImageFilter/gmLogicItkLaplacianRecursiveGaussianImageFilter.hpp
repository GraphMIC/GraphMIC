...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class LaplacianRecursiveGaussianImageFilter : public ImageToImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<LaplacianRecursiveGaussianImageFilter> Register;
                ...
                LaplacianRecursiveGaussianImageFilter() : ImageToImageFilter("LaplacianRecursiveGaussianImageFilter")
                {
                    log_trace(Log::New);
                    
                    this->addParamGroup("LaplacianRecursiveGaussianImageFilter");
