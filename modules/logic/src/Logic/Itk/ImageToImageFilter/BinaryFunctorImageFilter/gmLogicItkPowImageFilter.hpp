...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class PowImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<PowImageFilter> Register;
                ...
                PowImageFilter() : BinaryFunctorImageFilter("PowImageFilter")
                {
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::PowImageFilter<ImageType, ImageType>;
