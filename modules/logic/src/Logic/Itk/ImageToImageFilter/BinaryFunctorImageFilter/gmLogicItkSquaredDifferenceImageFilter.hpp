...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class SquaredDifferenceImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<SquaredDifferenceImageFilter> Register;
                ...
                SquaredDifferenceImageFilter() : BinaryFunctorImageFilter("SquaredDifferenceImageFilter")
                {
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::SquaredDifferenceImageFilter<ImageType, ImageType, ImageType>;
