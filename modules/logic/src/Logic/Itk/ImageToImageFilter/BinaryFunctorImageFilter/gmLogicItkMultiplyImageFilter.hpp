...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class MultiplyImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<MultiplyImageFilter> Register;
                ...
                MultiplyImageFilter() : BinaryFunctorImageFilter("MultiplyImageFilter")
                {
