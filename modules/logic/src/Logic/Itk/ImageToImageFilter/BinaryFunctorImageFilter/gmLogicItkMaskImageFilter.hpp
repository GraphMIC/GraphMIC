...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class MaskImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<MaskImageFilter> Register;
                ...
                MaskImageFilter() : BinaryFunctorImageFilter("MaskImageFilter")
                {
                    log_trace(Log::New, this);
                    
                    this->addParamGroup("MaskImageFilter");
                    ...
                    this->add(new Slot::Output<Data::Image>("output", Access::MakeConstraints()));
                }
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::MaskImageFilter<ImageType, ImageType>;
