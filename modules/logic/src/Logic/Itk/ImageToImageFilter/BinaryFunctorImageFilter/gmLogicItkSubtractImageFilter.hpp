...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class SubtractImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<SubtractImageFilter> Register;
                ...
                SubtractImageFilter() : BinaryFunctorImageFilter("SubtractImageFilter")
                {
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::SubtractImageFilter<ImageType, ImageType>;
