...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class XorImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<XorImageFilter> Register;
                ...
                XorImageFilter() : BinaryFunctorImageFilter("XorImageFilter")
                {
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::XorImageFilter<ImageType, ImageType>;
