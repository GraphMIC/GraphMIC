...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class BinaryMagnitudeImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<BinaryMagnitudeImageFilter> Register;
                ...
                BinaryMagnitudeImageFilter() : BinaryFunctorImageFilter("BinaryMagnitudeImageFilter")
                {
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::BinaryMagnitudeImageFilter<ImageType, ImageType, ImageType>;
