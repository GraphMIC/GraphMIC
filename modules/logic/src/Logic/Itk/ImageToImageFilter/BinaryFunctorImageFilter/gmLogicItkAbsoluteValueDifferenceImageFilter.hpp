...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class AbsoluteValueDifferenceImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<AbsoluteValueDifferenceImageFilter> Register;
                ...
                AbsoluteValueDifferenceImageFilter() : BinaryFunctorImageFilter("AbsoluteValueDifferenceImageFilter")
                {
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::AbsoluteValueDifferenceImageFilter<ImageType, ImageType, ImageType>;
