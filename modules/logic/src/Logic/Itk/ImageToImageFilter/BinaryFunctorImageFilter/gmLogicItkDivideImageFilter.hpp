...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class DivideImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<DivideImageFilter> Register;
                ...
                DivideImageFilter() : BinaryFunctorImageFilter("DivideImageFilter")
                {
