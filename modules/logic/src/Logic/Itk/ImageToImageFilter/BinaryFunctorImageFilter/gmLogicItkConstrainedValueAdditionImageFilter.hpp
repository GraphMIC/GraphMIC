...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class ConstrainedValueAdditionImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<ConstrainedValueAdditionImageFilter> Register;
                ...
                ConstrainedValueAdditionImageFilter() : BinaryFunctorImageFilter("ConstrainedValueAdditionImageFilter")
                {
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::ConstrainedValueAdditionImageFilter<ImageType, ImageType, ImageType>;
