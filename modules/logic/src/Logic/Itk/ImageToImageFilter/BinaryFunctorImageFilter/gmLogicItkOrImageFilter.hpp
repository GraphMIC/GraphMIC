...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class OrImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<OrImageFilter> Register;
                ...
                OrImageFilter() : BinaryFunctorImageFilter("OrImageFilter")
                {
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::OrImageFilter<ImageType, ImageType>;
