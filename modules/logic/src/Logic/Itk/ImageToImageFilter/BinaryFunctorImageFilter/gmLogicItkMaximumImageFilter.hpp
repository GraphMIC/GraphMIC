...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class MaximumImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<MaximumImageFilter> Register;
                ...
                MaximumImageFilter() : BinaryFunctorImageFilter("MaximumImageFilter")
                {
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::MaximumImageFilter<ImageType, ImageType>;
