...
namespace gm
{
    namespace Logic
    {
        namespace Itk
        {
            class ConstrainedValueDifferenceImageFilter : public BinaryFunctorImageFilter
            {
            public:
                struct ID
                {
                ...
                static Register<ConstrainedValueDifferenceImageFilter> Register;
                ...
                ConstrainedValueDifferenceImageFilter() : BinaryFunctorImageFilter("ConstrainedValueDifferenceImageFilter")
                {
                ...
                auto process() -> void
                {
                    ...
                    using FilterType    = itk::ConstrainedValueDifferenceImageFilter<ImageType, ImageType, ImageType>;
